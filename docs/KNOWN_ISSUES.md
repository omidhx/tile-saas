...
| گزارش‌های مدیریتی | ✅ v2 — عملکرد نماینده، پرفروش، راکد. ارزش از snapshot، کارتن از لجر. v9: تخفیف‌های اعمال‌شده (از `discount_amount`ِ همان snapshot) به‌تفکیکِ نماینده و کالا | spec ۹ |
