...
## ۷. سؤال‌های معلق — قبل از قطعی‌کردن این بخش‌ها با کارخونه حرف بزن

### با پشتیبان فروش
اکسل چه ستون‌هایی داره؟ فیزیکیه یا قابل‌فروش؟ Snapshot یا Delta؟ فروش تلفنی چطور ثبت می‌شه؟ مشتری نهایی سابقه‌دار می‌شه یا هربار آزاد؟

### با انباردار
- شید/کالیبر رو کجا/چطور نگه می‌دارید — یا اصلاً نگه نمی‌دارید؟ ممکنه داخل شماره‌ی بچ کدگذاری شده باشه؟
- موجودی با کارتن شمرده می‌شه یا پالت؟ هر پالت چند کارتنه، و این عدد در طول زمان عوض شده؟
- برند دقیقاً ویژگیِ محصوله یا بسته/بچ؟
- «ستون»/محل قفسه چقدر مهمه؟
- یه سفارش می‌تونه از چند Lot تأمین بشه؟

### با نماینده
- موقع رزرو، شید/بچ براش مهمه یا نه؟ پروژه‌ی جدید در برابر تکمیل پروژه فرق داره؟
- چند ساعت TTL رزرو کافیه؟ (پیش‌فرض کدنویسی: ۲۴ ساعت)
- آیا با چند کارخونه هم‌زمان کار می‌کنه؟ برند در انتخاب کالا مهمه؟
- آیا مخلوط دو شید در یه سفارش ممنوعه؟
