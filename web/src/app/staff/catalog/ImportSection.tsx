...
const MAX_FILE_BYTES = 10 * 1024 * 1024; // فایلِ موجودی هیچ‌وقت واقعاً این‌قدر بزرگ نیست
...
export default function ImportSection({ ctx }: { ctx: Ctx }) {
