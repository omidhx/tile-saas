...
export default function AuditPage() {
  ...
  if (ctx.role === "staff" && !hasPageAccess(ctx.allowedPages, "audit"))
    ...
    <main>
      ...
      <div className="banner banner--info">
        ...
        <span>
          ...
          حرکتِ موجودی در <Link href="/staff/ledger">دفتر حرکات</Link> است و دلیلِ تأییدِ هر
          سفارش روی خودِ سفارش.
        </span>
      </div>
