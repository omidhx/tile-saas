...
| گزارش‌های مدیریتی | ✅ v2 — عملکرد نماینده، پرفروش، راکد. ارزش از snapshot، کارتن از لجر. v9: تخفیف‌های اعمال‌شده (از `discount_amount`ِ همان snapshot) به‌تفکیکِ نماینده و کالا + فیلترِ اختیاریِ نماینده/کالا رویِ کلِ گزارش (راکدها فقط فیلترِ کالا را می‌پذیرد، چون موجودی مالِ نماینده‌ی خاصی نیست) + عملکردِ نماینده ماه‌به‌ماهِ شمسی (۳/۶/۱۲ ماهِ اخیر، برایِ دیدنِ روند نه یک بازه‌ی تکی) | spec ۹ |
